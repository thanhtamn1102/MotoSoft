...
public class ProductItemCategoryView extends HBox {
    ...
    @FXML private CheckBox cbkSelect;
    ...
    public ProductItemCategoryView(SanPham product) {
    ...
    private void init() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(MotoSoftApp.class.getResource("cus_comp_views/product-item-category-view.fxml"));
