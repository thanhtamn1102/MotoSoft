...
public class PTHImageItem extends Pane {
    ...
    public PTHImageItem(String imageAddress) {
    ...
    private void init() {
        FXMLLoader fxmlLoader = new FXMLLoader(MotoSoftApp.class.getResource("cus_comp_views/pth-image-item.fxml"));
